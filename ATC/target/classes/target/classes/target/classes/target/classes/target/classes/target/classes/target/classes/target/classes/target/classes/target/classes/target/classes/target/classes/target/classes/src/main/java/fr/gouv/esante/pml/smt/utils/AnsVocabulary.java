...
public enum AnsVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** version_creation.         */ version_creation            ("version_creation",            DATA_PROPERTY),
	/** status_entité         */ status_entité           ("status_entité",            ANNOTATION_PROPERTY),
	/** version_derniereModification         */ version_derniereModification            ("version_derniereModification",            ANNOTATION_PROPERTY),
	/** version_obsolescence.         */ version_obsolescence            ("version_obsolescence",            ANNOTATION_PROPERTY),
	/** replacedBy.         */ replacedBy            ("replacedBy",            ANNOTATION_PROPERTY);
...
//@formatter:on
	...
	AnsVocabulary(final String localname, final EntityType<?> entityType) {
		this.localName = localname;
		this.prefixedName = NameSpace.ANS.getPrefixName() + ':' + localname;
		this.entityType = entityType;
		this.iri = IRI.create(NameSpace.ANS.toString(), localname);
	}

	private static Stream<AnsVocabulary> stream() {
	 ...
	 */
	public static Set<OWLAnnotationProperty> getAnnotationProperties(final AnnotationPropertyProvider dataFactory) {
